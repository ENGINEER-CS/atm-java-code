...
public class BankController {
	...
	public static void main(String[] args) {
		...
		// for taking a input from a user
		Scanner sc = new Scanner(System.in);
		
		// storing user objects
		ArrayList<User> atm = new ArrayList<>();
		...
		try {
			...
			atm.add(new User(14523698, "Elon Musk", 1289, 50000000));
			atm.add(new User(78549632, "Donald Trump", 2526, 39999990));
			atm.add(new User(54856947, "Steve Jobs", 9398, 35000990));
			atm.add(new User(11455587, "Sachin Tendulkar", 8612, 9008800));
			atm.add(new User(99676898, "Rahul Gandhi", 1234, 0));
			atm.add(new User(41212455, "Alex Morton", 1279, 5800000));
			atm.add(new User(48963689, "Amitabh Bacchan", 2526, 785000));
			atm.add(new User(55454899, "Arnab Goswami", 9398, 3880990));
			atm.add(new User(78333588, "Mamta Banerjee", 8612, 900));
			...
			while (true) {
				...
				case 1:
					...
					String new_name_first = sc.next();
					System.out.print("Enter Last Name: ");
					String new_name_last = sc.next();

                    // int random = (int) (Math.random()*(end range - start range+1)+start range);					
					int random_account = (int) (Math.random() * (99999999 - 10000000 +  1) + 10000000);
					int random_pin = (int) (Math.random() * (9999 - 1000 + 1) + 1000);

					atm.add(new User(random_account, (new_name_first + " " + new_name_last), random_pin, 0));

					System.out.println("\n>>New Account Created Successfully<<");
					System.out.println("New Acc. no.=" + random_account);
